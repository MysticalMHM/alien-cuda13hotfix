...
> [!IMPORTANT]
> this branch is based off of releases/v4.12, the `cuda13hotfix` branch is the only branch with fixes
...
```
git clone --branch cuda13hotfix --recursive https://github.com/MysticalMHM/alien-cuda13hotfix.git
```
